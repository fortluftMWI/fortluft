<?
$MESS["PROFILE_TITLE"] = "Персональные данные";
$MESS["PROFILE_DATA_SAVED"] = "Изменения сохранены";
$MESS["PRYMERY_INFO_MESSAGE"] = "Персональные данные будут использованы только для уточнения деталей заказа/доставки и информировании Вас о статусе заказа.";
...
$MESS["PERSONAL_EMAIL"] = "Эл. почта";
$MESS["PROFILE_SAVE"] = "Сохранить изменения";

$MESS["EMAIL_DESC"] = "Для оповещения о смене статуса заказа";
$MESS["PHONE_DESC"] = "Для уточнения деталей заказа";
$MESS["LOGIN_DESC"] = "Логин для авторизации на сайте";
$MESS["NAME_DESC"] = "Заполните, чтобы мы знали, как к вам обращаться";
