	<?
	$MESS ["PASSWORDS_DOES_NOT_MATCH"] = "Пароли не совпадают";
	$MESS ["PRYMERY_PASS_INFO"] = "Если вы забудете новый пароль, то сможете восстановить его с помощью эл.почты указанной при регистрации.";
	$MESS ["CHANGE_PASSWORD"] = "Сменить пароль";
	$MESS ["CHANGE_PASSWORD_TITLE"] = "Изменение пароля";
