...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
						...
						label = BX.create('DIV', {
							children: [
								BX.create('INPUT', {
									...
									props: {type: 'radio', name: 'PERSON_TYPE', id: 'PERSON_TYPE_'+currentType.ID, value: currentType.ID}
								}),
								BX.create('LABEL', {
									attrs: {for: 'PERSON_TYPE_'+currentType.ID},
									children: BX.util.htmlspecialchars(currentType.NAME)
								}),
		...
		editPaySystemItems: function(paySystemNode)
		{
			...
			var paySystemItemsContainer = BX.create('DIV', {props: {className: 'col-sm-12 bx-soa-pp-item-container pay-container'}}),
				paySystemItemNode, i;
					...
					BX.create('DIV', {
						...
						children: [
							BX.create('A', {
								props: {
									href: 'javascript:void(0)',
									className: 'adp-btn adp-btn--primary btn-order-save'
								},
