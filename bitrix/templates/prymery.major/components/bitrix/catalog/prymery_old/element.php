...
$use_compare = PRmajor::GetDisplayProp('USE_COMPARE');
$use_favorites = PRmajor::GetDisplayProp('USE_FAVORITES');
...
<?$section_id = CIBlockElement::GetByID($elementId)->GetNext()['IBLOCK_SECTION_ID'];
	$wbuys = array();
    $res_wbuys = CIBlockElement::GetProperty($arParams['IBLOCK_ID'], $elementId, "sort", "asc", array("CODE" => "SIMPLE"));
    while ($ob_wbuys = $res_wbuys->GetNext())
    {
        $wbuys[] = $ob_wbuys['VALUE'];
    }
	?>
<?if($wbuys[0]){?>
	<section class="section-similar-product">
		<div class="container">
			<div class="section-heading">
				<div class="row">
					<div class="col-12">
						<div class="section-title text-center"><?=GetMessage('CATALOG_BUY_PRODUCT');?></div>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
					...
					global $mainTabsFilter2;
					$mainTabsFilter2['ID'] = $wbuys;
					$APPLICATION->IncludeComponent(
						...
						array(
							...
							"META_DESCRIPTION" => "-",
							"META_KEYWORDS" => "-",
							"OFFERS_CART_PROPERTIES" =>  $arParams['OFFER_TREE_PROPS'],
							"OFFERS_FIELD_CODE" =>  $arParams['OFFER_TREE_PROPS'],
							"OFFERS_LIMIT" => "",
...
<section class="section-popular-product">
	<div class="container">
		<div class="section-heading">
			<div class="row">
				<div class="col-12">
					<div class="section-title text-center"><?=GetMessage('CATALOG_SIMPLE_PRODUCT');?></div>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-12"> 
				...
				global $mainTabsFilter;
				$mainTabsFilter['!ID'] = $elementId;
				$APPLICATION->IncludeComponent(
					"bitrix:catalog.section",
					"recommendSlider",
					array(
						"JS_ID_OFFERS" => "RECOMMEND",
						"USE_COMPARE" => $use_compare,
						"USE_FAVORITES" => $use_favorites,
						"CUSTOM_CLASS" => $class,
						"ACTION_VARIABLE" => "action",
