...
?>
<div class="product-item noBottomRadius" itemscope="" itemtype="http://schema.org/Product">
                ...
                <div class="slider-container">
					<div class="product-item__slider">
						<? if ($arResult['DETAIL_PICTURE']['RESIZE']['BIG']['src']): ?>
							<div class="slide"><a href="<?=$arResult['DETAIL_PICTURE']['SRC']?>" data-fancybox="gallery"><img itemprop="image" src="<?= $arResult['DETAIL_PICTURE']['RESIZE']['BIG']['src'] ?>" alt="<?= $arResult['NAME'] ?>" title="<?= $arResult['NAME'] ?>"></a></div>
						<? endif; ?>
						<? if ($arResult['PHOTOS']): ?>
							<? foreach ($arResult['PHOTOS'] as $photo): ?>
								<div class="slide"><a href="<?=$photo['BIG']['src']?>" data-fancybox="gallery"> <img itemprop="image" src="<?= $photo['BIG']['src'] ?>" alt="<?= $photo['DESCRIPTION'] ?>" title="<?= $photo['DESCRIPTION'] ?>"></a></div>
							<? endforeach; ?>
						<? endif; ?>
					</div>
				...
				<div class="product-item__order">
					<div class="d-flex product-order-group">
						...
						<div class="product-item__total">
                            ...
                            =
                            <div class="product-item__priceGroup" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                <span class="js-price" data-val="<?=$explode_price[0]?>" data-price="<?=$explode_price[1]?>"><span itemprop="price"><?=$explode_price[0];?></span> <span itemprop="priceCurrency"><?=$explode_price[1]?></span></span>
                                ...
                                <?foreach($arResult['ADVANTAGES'] as $adv):?>
                                    <li>
                                        <span data-toggle="tooltip" data-placement="top" data-html="true" title="" data-original-title="<?=$adv['NAME']?>">
                                            <img itemprop="image" src="<?=CFile::GetPath($adv['PREVIEW_PICTURE']);?>" alt="<?=$adv['NAME']?>" title="<?=$adv['NAME']?>">
                                        </span>
                                    </li>
                                <?endforeach;?>
                            </ul>
