...
if($arResult['DISPLAY_FILTER']):  ?>
<div class="product-filter">
    <div class="title"><?=GetMessage('CT_BCSF_FILTER_TITLE_MAIN')?></div>
    <div class="bx-filter bx-blue">
        <div class="bx-filter-section">
            <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
                ...
                <div>
                    <?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
                    {
                        ...
                        if(isset($arItem["PRICE"])):
                            ...
                            <div class="bx-filter-parameters-box bx-active item">
                                ...
                                <div class="bx-filter-parameters-box-title heading">
                                    <span><?= GetMessage('FILTER_PRICE') ?></span>
                                    <svg class="icon icon-md"><use xlink:href="#angle-down"></use></svg>
                                </div>
                    ...
                    foreach($arResult["ITEMS"] as $key=>$arItem)
                    {
                        ...
                        if (
                            ...
                            continue;
                        ?>
                        <div class="bx-filter-parameters-box item <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
                            <span class="bx-filter-container-modef"></span>
                ...
                <div class="actions d-flex flex-wrap flex-lg-column justify-content-center">
                    <input
                            class="adp-btn adp-btn--secondary-outline font-bold text-sm"
                            type="submit"
                            id="set_filter"
                            name="set_filter"
