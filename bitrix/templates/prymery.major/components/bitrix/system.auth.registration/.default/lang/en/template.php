...
$MESS ['AUTH_NAME'] = "Фамилия Имя Отчество";
...
$MESS ['LOGIN_DESC'] = "Логин для входа в личный кабинет.";
$MESS ['NAME_DESC'] = "Заполните, чтобы мы знали, как к вам обращаться.";
$MESS ['EMAIL_DESC'] = "Для информирования при изменении статуса заказа.";
$MESS ['PASS_DESC'] = "Пароль должен состоять минимум из 6 знаков.";
$MESS ['USER_PERSONAL'] = "Я согласен на обработку";
$MESS ['PERSONAL_DATA'] = "персональных данных";
