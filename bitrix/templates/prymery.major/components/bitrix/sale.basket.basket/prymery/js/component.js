;(function() {
	...
	BX.Sale.BasketComponent = {
		...
		init: function(parameters)
		{
			...
			if(window.location.hash.replace("#","")=='delay'){
				this.toggleFilter('delayed');
			}
		},
		...
		showDelayedItemsCount: function()
		{
			...
			if (BX.type.isDomNode(itemCountNode))
			{
				...
				{
					if(window.location.hash.replace("#","")=='delay'){
						$('#basket-item-list-empty-result').show();
						$('#basket-items-list-container').height('300px');
						$('.cart__heading,div[data-entity=basket-items-list-header]').hide();
						itemCountNode.style.display = 'none';
					}
				}
			}
