...
<script id="basket-item-template" type="text/html">
    <li class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}} cart__item d-flex align-items-center" id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}">
        {{#SHOW_RESTORE}}
        ...
        <div class="basket-items-list-item-descriptions">
            <div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
                ...
                {
                ?>
                <div class="cart__thumb basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '')?>">
                    {{#DETAIL_PAGE_URL}}
            ...
            <div class="basket-item-block-info">
                <div class="cart__head">
                    <div class="cart__title font-bold">
                        {{#DETAIL_PAGE_URL}}
                ...
                <div class="basket-items-list-item-warning-container">
                    <div class="alert alert-warning text-center">
                        <a href="javascript:void(0)" class="add-favorites active" data-id="{{PRODUCT_ID}}" data-entity="basket-item-delete"><span class="icon"><i class="icon-heart"></i></span></a>

                        <?=Loc::getMessage('SBB_BASKET_ITEM_DELAYED')?>.
                        <a href="#all" data-entity="basket-item-remove-delayed">
        ...
        {
            ?>
            <div class="cart__price basket-items-list-item-price basket-items-list-item-price-for-one<?=(!isset($mobileColumns['PRICE']) ? ' hidden-xs' : '')?>">
                <div class="basket-item-block-price">
                    ...
                    <div class="cart__price-value font-bold">
                                <span id="basket-item-price-{{ID}}">
                                    {{{PRICE_FORMATED}}}
                                </span>
                    </div>

                    <div class="cart__price-tip text-secondary">
        ...
        ?>
        <div class="product__quantity basket-items-list-item-amount">
            <div class="adp-quantity basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
                 data-entity="basket-item-quantity-block">
                <span class="quantity-controller quantity-minus basket-item-amount-btn-minus" data-entity="basket-item-quantity-minus"></span>
                <div class="basket-item-amount-filed-block">
                    <input type="text" class="quantity__value basket-item-amount-filed" value="{{QUANTITY}}"
                           {{#NOT_AVAILABLE}} disabled="disabled"{{/NOT_AVAILABLE}}
                    data-value="{{QUANTITY}}" data-entity="basket-item-quantity-field"
                    id="basket-item-quantity-{{ID}}">
                </div>
                <span class="quantity-controller quantity-plus basket-item-amount-btn-plus" data-entity="basket-item-quantity-plus"></span>
                {{#SHOW_LOADING}}
                <div class="basket-items-list-item-overlay"></div>
                {{/SHOW_LOADING}}
            </div>
        ...
        {
            ?>
            <div class="cart__price-summary basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' hidden-xs' : '')?>">
                <div class="basket-item-block-price">
                    {{#SHOW_DISCOUNT_PRICE}}
                    <div class="basket-item-price-old">
                    ...
                    <div class="cart__price-value font-bold basket-item-price-current">
