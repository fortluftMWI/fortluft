		...
		<div class="row">
            <div class="basket-items-list-wrapper basket-items-list-wrapper-light<?=$displayModeClass?>" id="basket-items-list-wrapper">
                <div class="justify-content-center" data-entity="basket-items-list-header">
                    <div class="col-cart-heading">
                        <div class="cart__total d-flex align-items-center justify-content-between justify-content-md-end">
                            ...
                            <a href="<?=$APPLICATION->GetCurPage();?>" class="deleteAllBasket adp-btn adp-btn-white"><?=GetMessage('CLEAR_BASKET');?></a>
                        </div>
                    </div>
                </div>
