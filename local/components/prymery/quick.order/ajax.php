...
require($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/main/include/prolog_before.php");
    ...
    while($arBasketItem = $resBasketItems->Fetch()){
        ...
        $arBasketItemsAllFull[]=$arBasketItem;
    }
    ...
    Add2BasketByProductID($_POST['ELEMENT_ID'], 1, array(), array());
    ...
    if($arBasketItems){
        ...
        if($arOrderDat["CURRENCY"]){
            $newOrder['CURRENCY'] = $arOrderDat["CURRENCY"];
        }else{
            $arOrderDat['CURRENCY'] = 'RUB';
        }
