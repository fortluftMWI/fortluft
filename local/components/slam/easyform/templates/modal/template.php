...
<?if($arParams['NAME_MODAL_BUTTON']):?>
    <div class="slam-easyform">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal<?=$FORM_ID?>"
        style=" color: black;     background-color: whitesmoke;    border-color: whitesmoke;     box-shadow: none;
                background-image: url(/local/templates/fortluft_finnit/img/help_red.png);     background-repeat: no-repeat;
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <? if($arParams['FORM_NAME']): ?>
                        <div class="title"><?=$arParams['FORM_NAME']?></div>
                    <? endif?>
                </div>
