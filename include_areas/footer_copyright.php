<p>© <?=date('Y');?> FORTLUFT - Technology as an art form. Все права защищены. Любое копирование контента преследуется по закону РФ. Все данные, представленные на сайте, 
							...
							2 статьи 437 Гражданского Кодекса Российской Федерации. Указанные цены являются рекомендованными и могут отличаться от действительных цен.</p>