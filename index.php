	...
	<div class="container">
		<div class="row">
			...
			<div class="col-12 col-md-5 col-lg-3">
				<?
				$APPLICATION->IncludeComponent("bitrix:news.list", "rightBannerFinn", Array(
					"DISPLAY_DATE" => "N",	// Выводить дату элемента
						"DISPLAY_NAME" => "Y",	// Выводить название элемента
						"DISPLAY_PICTURE" => "Y",	// Выводить изображение для анонса
						"DISPLAY_PREVIEW_TEXT" => "Y",	// Выводить текст анонса
						"AJAX_MODE" => "N",	// Включить режим AJAX
						"IBLOCK_TYPE" => "prymery_major_content",	// Тип информационного блока (используется только для проверки)
						"IBLOCK_ID" => PRmajor::CIBlock_Id("prymery_major_content","prymery_major_banners"),	// Код информационного блока
